...
import AboutImg from "../assets/neha-profile.jpg";
...
const About = () => {
  ...
  “Hi there, I’m Neha Rajput.

I’m a passionate and hardworking developer currently pursuing my MCA. I have strong skills in web development, with hands-on experience in HTML, CSS, JavaScript, React.js, Node.js, PHP, and MySQL. I’ve built and contributed to several real-world projects.”
</p>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-base text-purple-700 font-semibold">
                I manage data, APIs, and server logic with tools like Node.js, and secure database systems.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-base text-purple-700 font-semibold">
                I handle database design and queries with MySQL, and PostgreSQL for optimized performance.
              </p>
            </div>
          </div>
        </div>
