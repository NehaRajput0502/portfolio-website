...
import nehaPhoto from "../assets/neha-profile.jpg";
import catImage from "../assets/cat.png";

const Home = () => {
  const fullText = "I'm Neha";
  ...
  const styleTag = `
    @keyframes neonPulse {
      0%, 100% {
        box-shadow: 0 0 10px rgb(37, 22, 30), 0 0 20px blue, 0 0 30px #ff80bf;
      }
      50% {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 z-30 mt-[-60px] mb-[-40px]">
        ...
        />
        <h1 className="text-[#000075] text-3xl md:text-5xl font-extrabold whitespace-nowrap">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-12 flex flex-col md:flex-row items-center justify-between relative">
          ...
          <div className="flex-1 text-center md:text-left space-y-4">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              I’m a passionate and hardworking developer currently pursuing my MCA, passionate about building
          ...
          <div className="w-full md:w-1/3 flex justify-center items-center mt-10 md:mt-0">
            <div style={neonGlowStyle}>
              ...
              />
              <div
                className="absolute bottom-2 right-2 bg-purple-400 text-white text-xs px-3 py-1 rounded-full shadow-md"
